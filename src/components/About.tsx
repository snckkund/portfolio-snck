  ...
  return (
    ...
    >
      ...
      <div className="neon-border bg-gray-800 bg-opacity-50 p-6 rounded-lg mb-8">
        <p className="mb-4">
          I'm SN Chandra Kanta Kund, a passionate student at VIT Bhopal, deeply interested in the fields of machine learning and geospatial analysis. My journey in technology is driven by a curiosity to explore how data can be leveraged to solve real-world problems.
        </p>
        <p className="mb-4">
